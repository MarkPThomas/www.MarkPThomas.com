...
$(document).ready(function(){
    console.log('checkboxSliderEvent');
    checkboxSliderEvent();
    console.log('checkboxEvent');
    checkboxEvent();
    console.log('selectionEvent');
    selectionEvent();
    console.log('selectionFuelUxEvent');
    selectionFuelUxEvent();
    console.log('spinBoxFuelUxEvent');
    spinBoxFuelUxEvent();
    console.log('checkAllCheckboxEvent');
    checkAllCheckboxEvent();
    console.log('deleteModalFormEvent');
    deleteModalFormEvent();
    console.log('iFrameDynamicSize');
    iFrameDynamicSize();
    console.log('selectImageEvent');
    selectImageEvent();
