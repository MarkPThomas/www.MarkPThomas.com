<?php namespace markpthomas\coding; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <meta name="description" content="A webpage for my coding-related activities.">
    <meta name="author" content="Mark Thomas">

    <title>Coding</title>

    <!--  Browser Icon  -->
    <link rel="shortcut icon" href="<?= Config::get('URL'); ?>favicon.ico?<?= time(); ?>" type="image/x-icon">
    <link rel="icon" href="<?= Config::get('URL'); ?>favicon.ico?<?= time(); ?>" type="image/x-icon">
    <link rel="apple-touch-icon" sizes="180x180" href="<?= Config::get('URL'); ?>apple-touch-icon.png?<?= time(); ?>">
    <link rel="icon" type="image/png" sizes="32x32" href="<?= Config::get('URL'); ?>favicon-32x32.png?<?= time(); ?>">
    <link rel="icon" type="image/png" sizes="16x16" href="<?= Config::get('URL'); ?>favicon-16x16.png?<?= time(); ?>">
