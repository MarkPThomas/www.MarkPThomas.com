...
return array(
     ...
     */
    'URL' => 'http://' . $_SERVER['HTTP_HOST'] . str_replace('main/public', '', dirname($_SERVER['SCRIPT_NAME'])),
    ...
    */
    ...
    'EMAIL_PASSWORD_RESET_FROM_EMAIL' => 'no-reply@MarkPThomas.com',
    'EMAIL_PASSWORD_RESET_FROM_NAME' => 'Mark P Thomas',
    'EMAIL_PASSWORD_RESET_SUBJECT' => 'Password reset for markpthomas.com',
    'EMAIL_PASSWORD_RESET_CONTENT' => 'Please visit this link to reset your password: ',

    'EMAIL_VERIFICATION_URL' => 'register/verify',
    'EMAIL_VERIFICATION_FROM_EMAIL' => 'no-reply@MarkPThomas.com',
    'EMAIL_VERIFICATION_FROM_NAME' => 'Mark P Thomas',
    'EMAIL_VERIFICATION_SUBJECT' => 'Account activation for markpthomas.com',
