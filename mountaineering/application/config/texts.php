...
return array(
    ...
    "FEEDBACK_CAPTCHA_BLANK" => "Please enter captcha security characters.",
    "FEEDBACK_RECAPTCHA_UNCHECKED" => "Please check the reCAPTCHA security box to prove that you aren't a bot.",
    "FEEDBACK_RECAPTCHA_WRONG" => "You appear to be a robot. What is love?",
    "FEEDBACK_PHONE_NUMBER_FIELD_EMPTY" => "Phone number field was empty.",
    "FEEDBACK_PHONE_NUMBER_DOES_NOT_FIT_PATTERN" => "Phone number does not fit a valid phone number pattern. Try 7 digits (no area code), 10 digits (area code included), or 11 digits (international number) and only use numbers, parentheses, dots, hyphens, spaces and pluses.",
    ...
    "FEEDBACK_PASSWORD_NEEDS_UPPERCASE" => "Password must contain at least 1 uppercase letter.",
    "FEEDBACK_PASSWORD_NEEDS_LOWERCASE" => "Password must contain at least 1 lowercase letter.",
    "FEEDBACK_PASSWORD_NEEDS_NUMERIC" => "Password must contain at least 1 number.",
    "FEEDBACK_PASSWORD_NEEDS_SPECIAL_CHARACTER" => "Password must contain at least 1 special character.",
    ...
    "FEEDBACK_FILE_DELETE_FAILED" => "File deletion failed: ",
    "FEEDBACK_FILE_DELETE_NO_FILE" => "File does not exist at the specified location: ",
    "FEEDBACK_FILE_MOVE_FAILED" => "Failed to move file: ",
    "FEEDBACK_FILE_UPLOAD_ERROR" => "File upload error: ",
    "FEEDBACK_FILE_IS_EMPTY" => "File is empty.",
    "FEEDBACK_FILE_NAME_INVALID_CHARACTERS" => "File name contains invalid characters: ",
    "FEEDBACK_FILE_NAME_TOO_LONG" => "File name exceeds 250 characters: ",
    "FEEDBACK_FILE_EXTENSION_INVALID" => "File name is not of a valid extension: ",
    "FEEDBACK_UPLOAD_WRONG_TYPE" => "File name is not of a valid type: ",
    "FEEDBACK_FILE_SIZE_TOO_BIG" => "File exceeds the allowed file size: ",
    "FEEDBACK_FOLDER_DOES_NOT_EXIST_OR_NOT_WRITABLE" => "Folder does not exist or is not writable. Please change this via chmod 775 or 777.",
    ...
    "FEEDBACK_ACCOUNT_STATUS_CHANGE_SUCCESSFUL" => "User status was set successfully.",
    "FEEDBACK_ACCOUNT_STATUS_CHANGE_FAILED" => "User status failed to be set.",
    "FEEDBACK_ACCOUNT_ROLE_CHANGE_SUCCESSFUL" => "User role was set successfully.",
    "FEEDBACK_ACCOUNT_ROLE_CHANGE_FAILED" => "User role failed to be set.",
    ...
    "FEEDBACK_EMAIL_FROM_FIELD_EMPTY" => "'Email' field cannot be empty.",
    "FEEDBACK_EMAIL_SUBJECT_FIELD_EMPTY" => "'Subject' field cannot be empty.",
    "FEEDBACK_EMAIL_BODY_FIELD_EMPTY" => "'Message' field cannot be empty.",
    "FEEDBACK_CONTACT_MAIL_SENDING_SUCCESSFUL" => "Your email was successfully sent.",
    "FEEDBACK_CONTACT_MAIL_SENDING_ERROR" => "There was an error in sending your email.",
    "FEEDBACK_REPORT_ALREADY_EXISTS" => "Something went wrong when submitting your report.",
    "FEEDBACK_REPORT_SUCCESSFULLY_CREATED" => "Report successfully submitted.",
    "FEEDBACK_REPORT_DELETION_SUCCESSFUL" => "Report successfully deleted.",
    "FEEDBACK_REPORT_DELETION_FAILED" => "Report was unable to be deleted.",
    "FEEDBACK_PAGE_ALREADY_EXISTS" => "A page by that name already exists.",
    "FEEDBACK_PAGE_DELETION_FAILED" => "Page was unable to be deleted.",
    "FEEDBACK_PHOTO_ALREADY_EXISTS" => "Photo already exists.",
    "FEEDBACK_PHOTO_DELETION_FAILED" => "Failed to delete photo.",
    "FEEDBACK_REPORT_PHOTO_DELETION_FAILED" => "Failed to delete report-photo association.",
    "FEEDBACK_VIDEO_ALREADY_EXISTS" => "Video already exists.",
    "FEEDBACK_VIDEO_DELETION_FAILED" => "Failed to delete video.",
    "FEEDBACK_REPORT_VIDEO_DELETION_FAILED" => "Failed to delete report-video association.",
    "FEEDBACK_ALBUM_ALREADY_EXISTS" => "Album already exists.",
    "FEEDBACK_ALBUM_DELETION_FAILED" => "Failed to delete album.",
    "FEEDBACK_REFERENCE_ALREADY_EXISTS" => "Reference already exists.",
    "FEEDBACK_REFERENCE_DELETION_FAILED" => "Failed to delete reference.",
    "FEEDBACK_SCRAPER_FILL_FAIL" => "Failed to find data associated with the specified scraper page ID."
);
