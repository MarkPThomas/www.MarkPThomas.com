...
// From John:
// https://stackoverflow.com/questions/5089841/two-way-encryption-i-need-to-store-passwords-that-can-be-retrieved/5093422#5093422
// https://security.stackexchange.com/questions/83180/secure-database-password-stored-in-an-env-variable/83229#83229
...
class Encryption
{
     ...
     * @param  string $plain
     * @return string
     * @throws \Exception If functions don't exist.
     */
     ...
     * @return string
     * @throws \Exception If $ciphertext is empty, or if functions don't exist.
     */
