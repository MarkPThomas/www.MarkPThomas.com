...
<div class="col-md-9">
    <h1 class="page-header">Maps & GIS</h1>
    <?php $this->renderFeedbackMessages(); ?>
    <p>This is my website for all map & GIS-related things.</p>
    ...
    <h2>Current State</h2>
    <p>Currently all that I have ready for public view is my Half Dome Map Project, and a basic root page for all site sub-domains.
