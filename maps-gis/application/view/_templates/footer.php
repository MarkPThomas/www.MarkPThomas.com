            ...
            <div class="col-md-6 col-md-push-7">
                <div class="row">
                    ...
                    <div class="col-md-6 sociallinks-footer">
                        ...
                        <a href="https://www.linkedin.com/in/mark-thomas-599b598" target="_blank" class="social-icon-wrapper w-inline-block" title="LinkedIn">
                            <img src="<?= Config::get('URL'); ?>public/img/icons/linkedIn/linkedIn_icon.svg" alt="linkedIn logo">
                        </a>
                        <a href="https://github.com/MarkPThomas" target="_blank" class="social-icon-wrapper w-inline-block" title="GitHub">
                            <img src="<?= Config::get('URL'); ?>/public/img/icons/gitHub/gitHub_icon.svg" alt="gitHub logo">
                        </a>
                        <a href="https://stackoverflow.com/users/3341503/pellucidwombat" target="_blank" class="social-icon-wrapper w-inline-block" title="StackOverflow">
