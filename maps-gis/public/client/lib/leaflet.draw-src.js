...
L.Draw.Polyline = L.Draw.Feature.extend({
	...
	options: {
		...
		metric: true, // Whether to use the metric meausrement system or imperial
...
//#==== My changes
  // icon: new L.Icon.Default(),
		icon: L.icon({
            iconAnchor: [6, 6],
						iconSize: [12, 12],
            iconUrl: '../public/images/editmarker.png'
    }),
    //#====         
    repeatMode: false,
...
L.EditToolbar.Edit = L.Handler.extend({
    ...
    // console(editedLayers);
    // console(JSON.stringify(editedLayers, null, 4));
